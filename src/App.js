    ...
    <div style={{ maxWidth: 980, margin: "0 auto", padding: 16, fontFamily: "system-ui, Arial" }}>
      ...
      <div style={{ background: "#fff", borderRadius: 12, padding: 16, boxShadow: "0 2px 8px rgba(0,0,0,0.06)", marginBottom: 16 }}>
        ...
        <p style={{ fontSize: 12, color: "#666", marginTop: 8 }}>
          Увага: програма веде два типи розрахунків: !-ий - дає прогноз на дві послідовні обробки фунгіцидами відносно дати висадки або заданої дати; 2-ий - будує систему захисту в кіці сезону на основі архіву погоду (для перевірки факичної системи захисту з розрахунковою)
        </p>
      </div>
