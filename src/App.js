...
>
  ...
  <br />1) <b>Прогноз на 14 днів</b> — моделює 14 днів після висадки на основі Open-Meteo (фокус на майбутні ризики).
  <br />2) <b>Створити модель системи захисту</b> — аналізує будь-який сезон за архівом NASA POWER і моделює систему захисту на весь сезон.
</p>
