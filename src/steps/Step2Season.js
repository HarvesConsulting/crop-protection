...
export default function Step2Season({
 ...
 return (
  <main className="flex justify-center items-start min-h-[70vh] px-4">  {/* ⬅️ той самий wrapper, що в Step1 */}
    <div className="w-full max-w-xl mx-auto bg-white rounded-xl shadow-lg">   {/* картка без внутрішніх відступів */}
      <div className="px-6 sm:px-10 py-6 space-y-6">                           {/* усі падінги тут */}
        {/* Заголовок + Інфо */}
        <div className="flex items-center justify-between">
          <h2 className="text-2xl font-bold text-gray-800">Крок 2: Дані про сезон</h2>
          <button
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
          <div className="flex flex-col flex-1">
            <label className="text-sm font-medium text-gray-700 mb-1 block">
              Дата висадки (або останнє внесення ЗЗР):
            </label>
            <input
              type="date"
              value={plantingDate}
