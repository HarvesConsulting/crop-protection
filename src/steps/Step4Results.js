        ...
        {showInfo && (
          ...
          >
            ...
            <p>
              ...
              захисту. Зверніть увагу на колір картки - зелений - низький рівень загрози захворювання (додаткових мі не потребує), жовтий - середній рівень загрози (потребує включення до бакової суміші додатковоо контактного препарату опційно), червоний - високий рівень загрози (потребує включення до бакової суміші додатково системного препарату опційно).
            </p>
          </div>
        )}
